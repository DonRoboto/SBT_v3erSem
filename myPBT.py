...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 16 23:08:33 2023
...
def _explore(
    ...
    """
    operations = {}
    new_config = copy.deepcopy(curr_config)
    for key, distribution in mutations.items():        
        new_config[key] = 0.7 * best_config[key] + 0.3 * curr_config[key]        
        operations[key] = "PSO perturbation"
        print("#======================#")
        print("#======================#")
        print("#======================#")
        print("#======================#")
        print(curr_config[key])
        print(best_config[key])
        print(new_config[key])
...
@PublicAPI
class SwarmBasedTraining(FIFOScheduler):
